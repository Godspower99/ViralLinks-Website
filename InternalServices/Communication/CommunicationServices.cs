    ...
    public class CommunicationServices : ICommunicationServices
    {
        ...
        public CommunicationServices(IConfiguration configuration)
        {
            ...
            try
            {
                ...
                _smtpClient.Authenticate("otietegodspower@gmail.com","wpgchsezupogrrkx");
            }
            catch (Exception ex)
            { 
                Log.Error("Communications Service Crashed on Construction Reason :: {0}", ex.Message);
            }
        }
        ...
        public async Task SendEmail(Email email)
        {
           try
            ...
            {
                Log.Error("Failed to send email Reason :: {0}", ex.Message);
            }
        }
        ...
        public async Task SendHtmlEmail(Email email)
        {
            ...
            {
                Log.Error("Failed to send html email Reason :: {0}", ex.Message);
            }                
        }
    }
}